...
//                borderRadius: BorderRadius.circular(12),
//                child: Image.asset(
//                  'assets/images/a1.png', // Đường dẫn đến ảnh trong assets
//                  fit: BoxFit.cover,
//                ),
//              ),
//            ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: TextStyle(
              color: Colors
                  .black), // Đổi màu chữ thành màu đen để phù hợp với nền trắng
        ),
        backgroundColor: Colors.white, // Đặt màu nền của AppBar thành màu trắng
        actions: [
          IconButton(
              ...
              Row(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 18,
                      color: Color.fromARGB(255, 33, 77, 130),
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                  InkWell(
